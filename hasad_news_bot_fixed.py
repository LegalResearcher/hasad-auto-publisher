...
دليل المصطلحات الإلزامي والرصين:
- "قوات صنعاء" للطرف الميداني والعسكري في الجبهات.
- "حكومة التغيير والبناء" أو "سلطات صنعاء" للشأن السياسي والاقتصادي والخدمي الخاص بصنعاء.
- "الحكومة الموالية للتحالف" أو "سلطة عدن" للسلطة التابعة للطرف الآخر.
- "التحالف بقيادة السعودية" بدلاً من "التحالف العربي".
