...
1. الإسناد الصحفي الاحترافي (Attribution): انسب المعلومات والوقائع دائماً إلى مصادرها (مثل: بحسب مصادر محلية، وفقاً لتقارير مصرفية، أفادت بيانات رسمية، ذكرت مصادر ميدانية).
2. تجريد النعوت والصفات العاطفية: يُمنع استخدام ألفاظ المديح أو الذم الفجة (مثل: خبيث، أسطوري، مخزي). استبدلها بصياغة "الأثر والنتيجة" (مثال: بدلاً من "الانهيار الفظيع للعملة"، اكتب: "التراجع المستمر وغير المسبوق للقيمة الشرائية للعملة المحلية").
...
- "حكومة التغيير والبناء" أو "سلطات صنعاء" أو "الجيش اليمني".
