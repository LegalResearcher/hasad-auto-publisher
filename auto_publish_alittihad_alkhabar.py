...
from hasad_news_bot_fixed import (
    ...
    RSS_YPAGENCY_GLOBAL_URL,
    RSS_YPAGENCY_GLOBAL_CATEGORY,
    RSS_YPAGENCY_ARAB_URL,
    RSS_YPAGENCY_ARAB_CATEGORY,
    RSS_YPAGENCY_GULF_URL,
    RSS_YPAGENCY_GULF_CATEGORY,
    RSS_YPAGENCY_REPORTS_URL,
    RSS_YPAGENCY_REPORTS_CATEGORY,
    RSS_YPAGENCY_ANALYSIS_URL,
    RSS_YPAGENCY_ANALYSIS_CATEGORY,
    RSS_YPAGENCY_OCCUPIED_PALESTINE_URL,
    RSS_YPAGENCY_OCCUPIED_PALESTINE_CATEGORY,
...
SELECTED_FEEDS = {
    ...
    # RSS_YPAGENCY_FULL_URL: RSS_YPAGENCY_FULL_CATEGORY,  # موقوف مؤقتاً
    # RSS_YPAGENCY_GLOBAL_URL: RSS_YPAGENCY_GLOBAL_CATEGORY,  # موقوف مؤقتاً
    # RSS_YPAGENCY_ARAB_URL: RSS_YPAGENCY_ARAB_CATEGORY,  # موقوف مؤقتاً
    # RSS_YPAGENCY_GULF_URL: RSS_YPAGENCY_GULF_CATEGORY,  # موقوف مؤقتاً
    # RSS_YPAGENCY_REPORTS_URL: RSS_YPAGENCY_REPORTS_CATEGORY,  # موقوف مؤقتاً
    # RSS_YPAGENCY_ANALYSIS_URL: RSS_YPAGENCY_ANALYSIS_CATEGORY,  # موقوف مؤقتاً
    # RSS_YPAGENCY_OCCUPIED_PALESTINE_URL: RSS_YPAGENCY_OCCUPIED_PALESTINE_CATEGORY,  # موقوف مؤقتاً
...
def build_auto_publish_prompt(title: str, body: str, category: str = "") -> str:
    return f"""
أنت محرر صحفي محترف ومتخصص. مطلوب منك إعادة صياغة الخبر التالي ليتناسب تماماً مع قسم ({category}) بأسلوب احترافي، دقيق، وبعيد تماماً عن أي استقطاب سياسي.
...
def rewrite_article_with_scope(title: str, body: str, category: str = "") -> Optional[dict]:
    ...
    prompt = build_auto_publish_prompt(title, body, category)
